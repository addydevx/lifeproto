    ...
    <main className="relative flex min-h-screen items-center justify-center px-6 py-12">
      ...
      >
        ...
        <div className="hud-panel hud-corners p-8">
          <div className="mb-6">
            <div className="mb-2 font-mono text-[10px] tracking-[0.25em] text-magenta">
            ...
            <p className="mt-2 text-xs text-fg-secondary">
              Provision a new operator profile. Begin at LVL 01.
            </p>
          </div>

          <form action={handleSubmit} className="space-y-4">
            <div>
              <label className="hud-label mb-1.5 block">CALLSIGN</label>
              <input
                type="text"
                name="callsign"
                required
                ...
                className="w-full border border-cyan/20 bg-ink-900/50 px-3 py-2.5 font-mono text-sm uppercase text-fg-primary placeholder:text-fg-muted focus:border-cyan focus:outline-none focus:ring-1 focus:ring-cyan/30 disabled:opacity-50"
              />
            </div>
            <div>
